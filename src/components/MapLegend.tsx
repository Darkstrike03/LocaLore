export default function MapLegend() {
  return (
    <div className="absolute bottom-4 left-4 z-[500] flex flex-col gap-1.5 rounded-xl border border-app-border bg-void/90 backdrop-blur-xl px-3 py-2.5 text-[10px] font-ui pointer-events-auto">
