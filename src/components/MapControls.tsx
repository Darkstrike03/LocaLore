export default function MapControls({
  ...
  return (
    <div className="absolute right-4 top-4 z-[500] flex items-center gap-2 rounded-xl border border-app-border bg-void/90 px-2 py-1 text-[12px] font-ui pointer-events-auto">
      <button
